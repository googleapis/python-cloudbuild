...
# source: google/devtools/cloudbuild_v1/proto/cloudbuild.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/devtools/cloudbuild_v1/proto/cloudbuild.proto",
...
Build = _reflection.GeneratedProtocolMessageType(
  ...
  expanded when the build is created:  -  $PROJECT\_ID: the project ID
  of the build. -  $BUILD\_ID: the autogenerated ID of the build. -
  $REPO\_NAME: the source repository name specified by RepoSource. -
  $BRANCH\_NAME: the branch name specified by RepoSource. -  $TAG\_NAME:
  the tag name specified by RepoSource. -  $REVISION\_ID or
  $COMMIT\_SHA: the commit SHA specified by RepoSource    or resolved
  from the specified branch or tag. -  $SHORT\_SHA: first 7 characters
  of $REVISION\_ID or $COMMIT\_SHA.
  Attributes:
      id:
      ...
      finish_time:
          ...
          finished.  The difference between finish\_time and start\_time
...
BuildTrigger = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      ignored_files:
          ignored\_files and included\_files are file glob matches using
          https://golang.org/pkg/path/filepath/#Match extended with
          support for "\*\*".  If ignored\_files and changed files are
          both empty, then they are not used to determine whether or not
          to trigger a build.  If ignored\_files is not empty, then we
          ignore any files that match any of the ignored\_file globs. If
          the change has no files that are outside of the ignored\_files
          globs, then we do not trigger a build.
      included_files:
          If any of the files altered in the commit pass the
          ignored\_files filter and included\_files is empty, then as
          far as this filter is concerned, we should trigger the build.
          If any of the files altered in the commit pass the
          ignored\_files filter and included\_files is not empty, then
          we make sure that at least one of those files matches a
          included\_files glob. If not, then we do not trigger a build.
  """,
...
GitHubEventsConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      event:
          ...
          Currently supported event types: push, pull\_request.
      pull_request:
...
PullRequestFilter = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      invert_regex:
          If true, branches that do NOT match the git\_ref will trigger
          a build.
  """,
...
WorkerConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      machine_type:
          ...
          builds#using\_custom\_virtual\_machine\_sizes
      disk_size_gb:
      ...
      network:
          ...
          WorkerPool.project\_id on the default network.
      tag:
...
Network = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      project_id:
          ...
          a peered VPC, this will be the same as the project\_id in
          which the workers are created. For a shared VPC, this will be
          the project sharing the network with the project\_id project
          in which workers will be created. For custom workers with no
          VPC, this will be the same as project\_id.
      network:
...
_CLOUDBUILD = _descriptor.ServiceDescriptor(
    ...
    index=0,
    serialized_options=_b(
        "\312A\031cloudbuild.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platform"
    ),
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002)" /v1/projects/{project_id}/builds:\005build\332A\020project_id,build\312A\037\n\005Build\022\026BuildOperationMetadata'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="GetBuild",
            ...
            output_type=_BUILD,
            serialized_options=_b(
                "\202\323\344\223\002'\022%/v1/projects/{project_id}/builds/{id}\332A\rproject_id,id"
            ),
        ),
        _descriptor.MethodDescriptor(
            name="ListBuilds",
            ...
            serialized_options=_b(
                '\202\323\344\223\002"\022 /v1/projects/{project_id}/builds\332A\021project_id,filter'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="CancelBuild",
            ...
            output_type=_BUILD,
            serialized_options=_b(
                '\202\323\344\223\0021",/v1/projects/{project_id}/builds/{id}:cancel:\001*\332A\rproject_id,id'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="RetryBuild",
            ...
            output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
            serialized_options=_b(
                '\202\323\344\223\0020"+/v1/projects/{project_id}/builds/{id}:retry:\001*\332A\rproject_id,id\312A\037\n\005Build\022\026BuildOperationMetadata'
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002-""/v1/projects/{project_id}/triggers:\007trigger\332A\022project_id,trigger'
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=_BUILDTRIGGER,
            serialized_options=_b(
                "\202\323\344\223\0021\022//v1/projects/{project_id}/triggers/{trigger_id}\332A\025project_id,trigger_id"
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002$\022"/v1/projects/{project_id}/triggers\332A\nproject_id'
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                "\202\323\344\223\0021*//v1/projects/{project_id}/triggers/{trigger_id}\332A\025project_id,trigger_id"
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=_BUILDTRIGGER,
            serialized_options=_b(
                "\202\323\344\223\002:2//v1/projects/{project_id}/triggers/{trigger_id}:\007trigger\332A\035project_id,trigger_id,trigger"
            ),
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
            serialized_options=_b(
                '\202\323\344\223\002="3/v1/projects/{project_id}/triggers/{trigger_id}:run:\006source\332A\034project_id,trigger_id,source\312A\037\n\005Build\022\026BuildOperationMetadata'
            ),
        ),
        _descriptor.MethodDescriptor(
