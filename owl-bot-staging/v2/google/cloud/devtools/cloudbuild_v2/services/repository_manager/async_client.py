...
class RepositoryManagerAsyncClient:
    ...
    get_transport_class = functools.partial(type(RepositoryManagerClient).get_transport_class, type(RepositoryManagerClient))
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def batch_create_repositories(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def fetch_read_write_token(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def fetch_read_token(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def fetch_linkable_repositories(self,
