...
class FetchLinkableRepositoriesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[repositories.FetchLinkableRepositoriesResponse]],
            request: repositories.FetchLinkableRepositoriesRequest,
            response: repositories.FetchLinkableRepositoriesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[repositories.FetchLinkableRepositoriesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
