...
class CloudBuildRestTransport(CloudBuildTransport):
    ...
    class _GetIamPolicy(CloudBuildRestStub):
        def __call__(self,
    ...
    class _SetIamPolicy(CloudBuildRestStub):
        def __call__(self,
    ...
    class _TestIamPermissions(CloudBuildRestStub):
        def __call__(self,
    ...
    class _CancelOperation(CloudBuildRestStub):
        def __call__(self,
    ...
    class _GetOperation(CloudBuildRestStub):
        def __call__(self,
