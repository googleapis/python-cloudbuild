...
from google.devtools.cloudbuild_v2.services.repository_manager import RepositoryManagerAsyncClient
from google.devtools.cloudbuild_v2.services.repository_manager import RepositoryManagerClient
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (RepositoryManagerAsyncClient, transports.RepositoryManagerGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RepositoryManagerClient, transports.RepositoryManagerGrpcTransport, "grpc", "true"),
    (RepositoryManagerAsyncClient, transports.RepositoryManagerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (RepositoryManagerClient, transports.RepositoryManagerGrpcTransport, "grpc", "false"),
    (RepositoryManagerAsyncClient, transports.RepositoryManagerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (RepositoryManagerClient, transports.RepositoryManagerRestTransport, "rest", "true"),
    (RepositoryManagerClient, transports.RepositoryManagerRestTransport, "rest", "false"),
])
@mock.patch.object(RepositoryManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RepositoryManagerClient))
@mock.patch.object(RepositoryManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RepositoryManagerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    RepositoryManagerClient, RepositoryManagerAsyncClient
])
@mock.patch.object(RepositoryManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RepositoryManagerClient))
@mock.patch.object(RepositoryManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RepositoryManagerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RepositoryManagerClient, transports.RepositoryManagerGrpcTransport, "grpc", grpc_helpers),
    (RepositoryManagerAsyncClient, transports.RepositoryManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (RepositoryManagerClient, transports.RepositoryManagerRestTransport, "rest", None),
])
...
def test_repository_manager_client_client_options_from_dict():
    with mock.patch('google.devtools.cloudbuild_v2.services.repository_manager.transports.RepositoryManagerGrpcTransport.__init__') as grpc_transport:
...
def test_get_connection(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = repositories.Connection(
            ...
            reconciling=True,
            etag='etag_value',
            github_config=repositories.GitHubConfig(authorizer_credential=repositories.OAuthCredential(oauth_token_secret_version='oauth_token_secret_version_value')),
        )
...
def test_list_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, repositories.Connection)
                   for i in results)
...
def test_batch_create_repositories(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_repositories),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, repositories.Repository)
                   for i in results)
...
async def test_list_repositories_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_repositories(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_fetch_read_write_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_read_write_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_read_token(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_read_token),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_fetch_linkable_repositories_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.fetch_linkable_repositories(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_connection_rest_interceptors(null_interceptor):
    transport = transports.RepositoryManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RepositoryManagerRestInterceptor(),
        )
    client = RepositoryManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_create_connection") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_create_connection") as pre:
...
def test_get_connection_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.Connection.pb(return_value)
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_get_connection") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_get_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_connections_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.ListConnectionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_list_connections") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_list_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_update_connection") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_update_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_delete_connection") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_delete_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_repository_rest(request_type):
    ...
    request_init["repository"] = {'name': 'name_value', 'remote_uri': 'remote_uri_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'annotations': {}, 'etag': 'etag_value'}
    request = request_type(**request_init)
...
def test_create_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_create_repository") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_create_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_batch_create_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_batch_create_repositories") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_batch_create_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_repository_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.Repository.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_get_repository") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_get_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_repositories_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.ListRepositoriesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_list_repositories") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_list_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_delete_repository") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_delete_repository") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_fetch_read_write_token_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.FetchReadWriteTokenResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_fetch_read_write_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_read_write_token") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_fetch_read_write_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_fetch_read_token_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.FetchReadTokenResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_fetch_read_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_read_token") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_fetch_read_token") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_fetch_linkable_repositories_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = repositories.FetchLinkableRepositoriesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_fetch_linkable_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_linkable_repositories") as post, \
         mock.patch.object(transports.RepositoryManagerRestInterceptor, "pre_fetch_linkable_repositories") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_repository_manager_base_transport():
    ...
    with mock.patch('google.devtools.cloudbuild_v2.services.repository_manager.transports.RepositoryManagerTransport.__init__') as Transport:
...
def test_repository_manager_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.devtools.cloudbuild_v2.services.repository_manager.transports.RepositoryManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_repository_manager_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.devtools.cloudbuild_v2.services.repository_manager.transports.RepositoryManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RepositoryManagerTransport()
        adc.assert_called_once()
...
def test_repository_manager_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RepositoryManagerGrpcTransport, transports.RepositoryManagerGrpcAsyncIOTransport])
def test_repository_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (RepositoryManagerAsyncClient, transports.RepositoryManagerGrpcAsyncIOTransport),
])
