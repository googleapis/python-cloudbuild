...
from google.cloud.devtools.cloudbuild_v1.services.cloud_build import CloudBuildAsyncClient
...
@pytest.mark.parametrize("client_class", [
    CloudBuildClient, CloudBuildAsyncClient
])
@mock.patch.object(CloudBuildClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudBuildClient))
@mock.patch.object(CloudBuildAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudBuildAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (CloudBuildAsyncClient, transports.CloudBuildGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CloudBuildClient, transports.CloudBuildRestTransport, "rest", None),
])
def test_cloud_build_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_cloud_build_client_client_options_from_dict():
    with mock.patch('google.cloud.devtools.cloudbuild_v1.services.cloud_build.transports.CloudBuildGrpcTransport.__init__') as grpc_transport:
...
def test_cloud_build_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_build_routing_parameters():
    ...
    request = cloudbuild.CreateBuildRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_get_build_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.GetBuildRequest(**{"name": "projects/sample1/locations/sample2/builds/sample3"})
...
def test_list_builds_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.ListBuildsRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_cancel_build_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.CancelBuildRequest(**{"name": "projects/sample1/locations/sample2/builds/sample3"})
...
def test_retry_build_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.RetryBuildRequest(**{"name": "projects/sample1/locations/sample2/builds/sample3"})
...
def test_approve_build_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.ApproveBuildRequest(**{"name": "projects/sample1/locations/sample2/builds/sample3"})
...
def test_create_build_trigger_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.CreateBuildTriggerRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_get_build_trigger_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.GetBuildTriggerRequest(**{"name": "projects/sample1/locations/sample2/triggers/sample3"})
...
def test_list_build_triggers_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.ListBuildTriggersRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_delete_build_trigger_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.DeleteBuildTriggerRequest(**{"name": "projects/sample1/locations/sample2/triggers/sample3"})
...
def test_update_build_trigger_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.UpdateBuildTriggerRequest(**{"trigger": {"resource_name": "projects/sample1/locations/sample2/triggers/sample3"}})
...
def test_run_build_trigger_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.RunBuildTriggerRequest(**{"name": "projects/sample1/locations/sample2/triggers/sample3"})
...
def test_create_worker_pool_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.CreateWorkerPoolRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_get_worker_pool_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.GetWorkerPoolRequest(**{"name": "projects/sample1/locations/sample2/workerPools/sample3"})
...
def test_delete_worker_pool_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.DeleteWorkerPoolRequest(**{"name": "projects/sample1/locations/sample2/workerPools/sample3"})
...
def test_update_worker_pool_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.UpdateWorkerPoolRequest(**{"worker_pool": {"name": "projects/sample1/locations/sample2/workerPools/sample3"}})
...
def test_list_worker_pools_routing_parameters():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = cloudbuild.ListWorkerPoolsRequest(**{"parent": "projects/sample1/locations/sample2"})
...
def test_create_build_rest(request_type):
    ...
    for field, value in request_init["build"].items():
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_build_rest_required_fields(request_type=cloudbuild.CreateBuildRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_build._get_unset_required_fields(jsonified_request)
...
def test_create_build_rest_unset_required_fields():
    transport = transports.CloudBuildRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_build._get_unset_required_fields({})
    assert set(unset_fields) == (set(("parent", )) & set(("projectId", "build", )))
...
def test_create_build_rest_interceptors(null_interceptor):
    transport = transports.CloudBuildRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CloudBuildRestInterceptor(),
        )
    client = CloudBuildClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_create_build") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_create_build") as pre:
        ...
        client.create_build(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_build_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.CreateBuildRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_build_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/projects/{project_id}/builds" % client.transport._host, args[1])
...
def test_get_build_rest_required_fields(request_type=cloudbuild.GetBuildRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_build._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_build_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("name", )) & set(("projectId", "id", )))
...
def test_get_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_get_build") as post, \
        ...
        client.get_build(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_build_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.GetBuildRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_build_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/builds/{id}" % client.transport._host, args[1])
...
def test_list_builds_rest_required_fields(request_type=cloudbuild.ListBuildsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_builds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_builds._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "page_size", "page_token", "parent", ))
    jsonified_request.update(unset_fields)
...
def test_list_builds_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", "parent", )) & set(("projectId", )))
...
def test_list_builds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_list_builds") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_list_builds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.ListBuildsResponse.to_json(cloudbuild.ListBuildsResponse())
        ...
        client.list_builds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_builds_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.ListBuildsRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_build_rest_required_fields(request_type=cloudbuild.CancelBuildRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_build._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_build_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("projectId", "id", )))
...
def test_cancel_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_cancel_build") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_cancel_build") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.cancel_build(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_cancel_build_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.CancelBuildRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_build_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/builds/{id}:cancel" % client.transport._host, args[1])
...
def test_retry_build_rest_required_fields(request_type=cloudbuild.RetryBuildRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retry_build._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_retry_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_retry_build") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_retry_build") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.retry_build(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_retry_build_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.RetryBuildRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retry_build_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/builds/{id}:retry" % client.transport._host, args[1])
...
def test_approve_build_rest_required_fields(request_type=cloudbuild.ApproveBuildRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).approve_build._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_approve_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_approve_build") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_approve_build") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.approve_build(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_approve_build_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.ApproveBuildRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_approve_build_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/builds/*}:approve" % client.transport._host, args[1])
...
def test_create_build_trigger_rest_required_fields(request_type=cloudbuild.CreateBuildTriggerRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_build_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_build_trigger_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parent", )) & set(("projectId", "trigger", )))
...
def test_create_build_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_create_build_trigger") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_create_build_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.CreateBuildTriggerRequest.pb(cloudbuild.CreateBuildTriggerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.BuildTrigger.to_json(cloudbuild.BuildTrigger())
        ...
        client.create_build_trigger(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_build_trigger_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.CreateBuildTriggerRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_build_trigger_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/triggers" % client.transport._host, args[1])
...
def test_get_build_trigger_rest_required_fields(request_type=cloudbuild.GetBuildTriggerRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_build_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_build_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_get_build_trigger") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_get_build_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.GetBuildTriggerRequest.pb(cloudbuild.GetBuildTriggerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_build_trigger(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_build_trigger_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.GetBuildTriggerRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_build_trigger_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/triggers/{trigger_id}" % client.transport._host, args[1])
...
def test_list_build_triggers_rest_required_fields(request_type=cloudbuild.ListBuildTriggersRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_build_triggers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_build_triggers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "parent", )) & set(("projectId", )))
...
def test_list_build_triggers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_list_build_triggers") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_list_build_triggers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.ListBuildTriggersRequest.pb(cloudbuild.ListBuildTriggersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.ListBuildTriggersResponse.to_json(cloudbuild.ListBuildTriggersResponse())
        ...
        client.list_build_triggers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_build_triggers_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.ListBuildTriggersRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_build_triggers_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloudbuild.ListBuildTriggersResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_build_trigger_rest_required_fields(request_type=cloudbuild.DeleteBuildTriggerRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_build_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_build_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_delete_build_trigger") as pre:
        pre.assert_not_called()
        pb_message = cloudbuild.DeleteBuildTriggerRequest.pb(cloudbuild.DeleteBuildTriggerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_build_trigger(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_build_trigger_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.DeleteBuildTriggerRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_build_trigger_rest_required_fields(request_type=cloudbuild.UpdateBuildTriggerRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_build_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_build_trigger_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("projectId", "triggerId", "trigger", )))
...
def test_update_build_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_update_build_trigger") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_update_build_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.UpdateBuildTriggerRequest.pb(cloudbuild.UpdateBuildTriggerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_build_trigger(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_build_trigger_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.UpdateBuildTriggerRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_build_trigger_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project_id': 'sample1', 'trigger_id': 'sample2'}
    request_init["source"] = {'project_id': 'project_id_value', 'repo_name': 'repo_name_value', 'branch_name': 'branch_name_value', 'tag_name': 'tag_name_value', 'commit_sha': 'commit_sha_value', 'dir_': 'dir__value', 'invert_regex': True, 'substitutions': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_run_build_trigger_rest_required_fields(request_type=cloudbuild.RunBuildTriggerRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).run_build_trigger._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_build_trigger_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_run_build_trigger") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_run_build_trigger") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.RunBuildTriggerRequest.pb(cloudbuild.RunBuildTriggerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.run_build_trigger(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_run_build_trigger_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.RunBuildTriggerRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_build_trigger_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/projects/{project_id}/triggers/{trigger_id}:run" % client.transport._host, args[1])
...
def test_receive_trigger_webhook_rest(request_type):
    ...
    request_init["body"] = {'content_type': 'content_type_value', 'data': b'data_blob', 'extensions': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["body"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_receive_trigger_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_receive_trigger_webhook") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_receive_trigger_webhook") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.ReceiveTriggerWebhookRequest.pb(cloudbuild.ReceiveTriggerWebhookRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.ReceiveTriggerWebhookResponse.to_json(cloudbuild.ReceiveTriggerWebhookResponse())
        ...
        client.receive_trigger_webhook(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_receive_trigger_webhook_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.ReceiveTriggerWebhookRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_worker_pool_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["worker_pool"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_worker_pool_rest_required_fields(request_type=cloudbuild.CreateWorkerPoolRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_worker_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_worker_pool._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("validate_only", "worker_pool_id", ))
    jsonified_request.update(unset_fields)
...
def test_create_worker_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("validateOnly", "workerPoolId", )) & set(("parent", "workerPool", "workerPoolId", )))
...
def test_create_worker_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_create_worker_pool") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_create_worker_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.CreateWorkerPoolRequest.pb(cloudbuild.CreateWorkerPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_worker_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_worker_pool_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.CreateWorkerPoolRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_worker_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/workerPools" % client.transport._host, args[1])
...
def test_get_worker_pool_rest_required_fields(request_type=cloudbuild.GetWorkerPoolRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_worker_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_worker_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_get_worker_pool") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_get_worker_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.GetWorkerPoolRequest.pb(cloudbuild.GetWorkerPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.WorkerPool.to_json(cloudbuild.WorkerPool())
        ...
        client.get_worker_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_worker_pool_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.GetWorkerPoolRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_worker_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/workerPools/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/workerPools/*}" % client.transport._host, args[1])
...
def test_delete_worker_pool_rest_required_fields(request_type=cloudbuild.DeleteWorkerPoolRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_worker_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_worker_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_delete_worker_pool") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_delete_worker_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.DeleteWorkerPoolRequest.pb(cloudbuild.DeleteWorkerPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_worker_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_worker_pool_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.DeleteWorkerPoolRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_worker_pool_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'worker_pool': {'name': 'projects/sample1/locations/sample2/workerPools/sample3'}}
    request_init["worker_pool"] = {'name': 'projects/sample1/locations/sample2/workerPools/sample3', 'display_name': 'display_name_value', 'uid': 'uid_value', 'annotations': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'state': 1, 'private_pool_v1_config': {'worker_config': {'machine_type': 'machine_type_value', 'disk_size_gb': 1261}, 'network_config': {'peered_network': 'peered_network_value', 'egress_option': 1, 'peered_network_ip_range': 'peered_network_ip_range_value'}}, 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_worker_pool_rest_required_fields(request_type=cloudbuild.UpdateWorkerPoolRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_worker_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_worker_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", "validateOnly", )) & set(("workerPool", )))
...
def test_update_worker_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_update_worker_pool") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_update_worker_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.UpdateWorkerPoolRequest.pb(cloudbuild.UpdateWorkerPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_worker_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_worker_pool_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.UpdateWorkerPoolRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_worker_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'worker_pool': {'name': 'projects/sample1/locations/sample2/workerPools/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{worker_pool.name=projects/*/locations/*/workerPools/*}" % client.transport._host, args[1])
...
def test_list_worker_pools_rest_required_fields(request_type=cloudbuild.ListWorkerPoolsRequest):
    transport_class = transports.CloudBuildRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_worker_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_worker_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "post_list_worker_pools") as post, \
         mock.patch.object(transports.CloudBuildRestInterceptor, "pre_list_worker_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloudbuild.ListWorkerPoolsRequest.pb(cloudbuild.ListWorkerPoolsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudbuild.ListWorkerPoolsResponse.to_json(cloudbuild.ListWorkerPoolsResponse())
        ...
        client.list_worker_pools(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_worker_pools_rest_bad_request(transport: str = 'rest', request_type=cloudbuild.ListWorkerPoolsRequest):
    client = CloudBuildClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_worker_pools_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloudbuild.ListWorkerPoolsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_cloud_build_base_transport():
    ...
    with mock.patch('google.cloud.devtools.cloudbuild_v1.services.cloud_build.transports.CloudBuildTransport.__init__') as Transport:
...
def test_cloud_build_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.devtools.cloudbuild_v1.services.cloud_build.transports.CloudBuildTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_build_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.devtools.cloudbuild_v1.services.cloud_build.transports.CloudBuildTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudBuildTransport()
        adc.assert_called_once()
...
def test_github_enterprise_config_path():
    project = "oyster"
    config = "nudibranch"
    expected = "projects/{project}/githubEnterpriseConfigs/{config}".format(project=project, config=config, )
